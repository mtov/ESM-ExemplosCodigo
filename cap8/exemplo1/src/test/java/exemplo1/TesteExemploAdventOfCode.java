...
*
* Teste do desafio (isto é, da classe ExemploAdventOfCode)
*
*/
...
*/
public class TesteExemploAdventOfCode {

  ExemploAdventOfCode aoc = new ExemploAdventOfCode();

  @Test
  public void teste1() {
    int[] input = new int[] {1721,979,366,299,675,1456};
    int produto = aoc.produtoSoma2020(input);
    assertEquals (514579, produto);
  }

  @Test
  public void teste2() {
    int[] input = new int[] {2000,20,1,2,3,4};
    int produto = aoc.produtoSoma2020(input);
    assertEquals (40000, produto);
  }

  @Test
  public void teste3() {
    int[] input = new int[] {2000,20,2000,3,4};
    int produto = aoc.produtoSoma2020(input);
    assertEquals (40000, produto);
  }
